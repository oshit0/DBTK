                            ...
                            <div class="form-group col-md-12 text-left mb-3">
                                <form method="post" action="${pageContext.request.contextPath}/inventory/edit">
                                    <c:forEach items="${itemDetails}" var="item">
                                        ...
                                        <div class="mb-1 row">
                                            <label for="itemDescription" class="col-sm-3 col-form-label">Item
                                                Description</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="mb-1 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control form-control-sm" id="itemSize"
                                                    name="itemSize" value="${item.itemSize}">
                                            </div>
                                        </div>
                                        <div class="mb-1 row">
                                        ...
                                        <div class="mb-1 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control form-control-sm" id="itemStocks"
                                                    name="itemStocks" value="${item.itemStocks}">
                                            </div>
                                        </div>
