                        ...
                        <div class="form-row">
                                ...
                                <tbody>
                                    <c:forEach items="${allUsers}" var="user">
                                        <tr>
                                            ...
                                            <td>${user.userType}</td>
                                            <td><a href="${pageContext.request.contextPath}/${path}?${query}${user.userId}"
                            ...
                            <div class="form-group col-md-4 text-center mb-3 ml-0 pl-0">
                                <a href="${pageContext.request.contextPath}/user/create/form"
                                    class="btn btn-dark submit">Add User</a>
                                <a href="${pageContext.request.contextPath}/user/edit" class="btn btn-dark submit">Edit
                                    User</a>
                                <a href="${pageContext.request.contextPath}/user/delete"
                                    class="btn btn-danger submit">Delete User</a>
                            </div>
                        </div>
                    </div>
                </div>
