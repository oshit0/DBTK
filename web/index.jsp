...
<html>
    ...
    <body>
        ...
        <%@include file="success-modal.jsp" %>
        ...
        <div class="container-fluid model">
            <div class="row">
                <div class="col-md-6 col-sm-0 p-0 model-left img-fluid"
                    style="background-image: url('img/homepage/maloi_left.jpg');">
                </div>
        ...
        <script type="text/javascript" src="${pageContext.request.contextPath}/js/update-navbar.js"></script>

    <%
        String showModal = (String) session.getAttribute("showModal");
