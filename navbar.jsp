...
<nav id="navbarHome" class="navbar navbar-expand-lg">
        <div class="container-fluid px-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav d-flex justify-content-between align-content-center ms-auto mb-2 mb-lg-0">
                                ...
                                <li class="nav-item">
                                        <a class="nav-link px- " aria-current="page" href="${pageContext.request.contextPath}/inventory">Shop</a>
                                </li>
                                <li class="nav-item">
                                        <a class="nav-link px- " aria-current="page" href="#">Gallery</a>
                                </li>
                        </ul>
